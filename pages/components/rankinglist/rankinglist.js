...
var albums = [{name: "Gluee", artist: "Bladee", src: "https://i1.sndcdn.com/artworks-000068528208-1w4h5h-t500x500.jpg", rating: 10, link: "tracklists/gluee"},
...
function rankinglist(){
    ...
    for(let i = 0; i < albums.length; i++){
        var obj = <ClickableAlbum name={albums[i].name} artist={albums[i].artist}
               src={albums[i].src} rating={albums[i].rating} link={albums[i].link} />
        objlist.push(obj)
    }
